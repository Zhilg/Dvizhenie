...
1. Чтение иерархии файлов в файловой системе. Возможные типы файлов:
 Текстовые. Формат: txt - кодировка - UTF-8.
2. Кластеризации подлежит тот же набор данных, что отдавали в /semantic/upload.
3. Векторизация файлов с использованием указанной модели, если это необходимо. Этот шаг необязательный, если вектора уже загружены /semantic/upload.
4. Кластеризация файлов
