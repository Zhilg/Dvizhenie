...
1. Принимает текст в любом формате
2. Выполняет:
...
BODY:
текст в кодировке, указанной в пункте charset заголовка
```
...
BODY: 
нормализованный текст в кодировке, указанной в пункте charset заголовка
```
Ошибки:
