...
- x-corpus-path: относительный путь к каталогу с файлами. Путь указывается относительно точки монтирования докера ПМ (обязательный)
  ...
  "results": [
    {
      ...
      "preview": "...контекстный фрагмент...", # 200 символов вокруг найденного фрагмента
...
?????? что понимается под preview? Что являются эталонной единицей?
================================================================================
